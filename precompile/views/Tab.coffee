...
# has one or more views
  constructor: (o) ->
    ...
    App.Window.active_tab = @ if o.active
    @views = []
  ...
  resize: (o) ->
    @x = o.x if o.x
    App.die "Tab.x may not be less than 1!" if @x < 1
    @y = o.y if o.y
    App.die "Tab.y may not be less than 1!" if @y < 1
    @w = o.w
    App.die "Tab.w may not be less than 1!" if @w < 1
    # outer
    @h = o.h
    App.die "Tab.h may not be less than 1!" if @h < 1 # TODO: or 2 if tab bar is present
    # inner
